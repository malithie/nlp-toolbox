...
/*
    ...
    public void testFindNameEntityTypeViaDictionary() throws InterruptedException {
        logger.info("FindNameEntityTypeViaDictionary Test 1");

        SiddhiConfiguration siddhiConfiguration = new SiddhiConfiguration();

        List<Class> list = new ArrayList<Class>();
        list.add(org.wso2.siddhi.extension.nlp.NameEntityTypeViaDictionaryTransformProcessor.class);
        ...
        String queryReference = siddhiManager.addQuery("from DataStream#transform.nlp:findNameEntityTypeViaDictionary" +
                "        ( 'PERSON', 'src/test/resources/dictionaryTest.xml', text ) \n" +
                "        select *  \n" +
                "        insert into FindNameEntityTypeViaDictionaryResult;\n");
