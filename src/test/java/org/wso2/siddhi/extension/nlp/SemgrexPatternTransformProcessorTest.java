...
public class SemgrexPatternTransformProcessorTest extends TestCase {
    private static Logger logger = Logger.getLogger(SemgrexPatternTransformProcessorTest.class);

    @Test
    public void testFindSemgrexPattern() throws InterruptedException {
        logger.info("FindSemgrexPattern Test 1");

        SiddhiConfiguration siddhiConfiguration = new SiddhiConfiguration();

        List<Class> list = new ArrayList<Class>();
        list.add(SemgrexPatternTransformProcessor.class);
